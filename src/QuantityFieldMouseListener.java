...
public class QuantityFieldMouseListener implements MouseListener
{
    private JTextField quantityField;   // QuantityFieldMouseListener HAS-A text field to clear
    private int clicks = 0;             // QuantityFieldMouseListener HAS-A number of clicks

    // Assignment Constructor for search bar and button
    public QuantityFieldMouseListener(JTextField quantityField)
    {
