 ...
 * To perform advanced (filtered) search when clicked
 */

public class SearchItemListener implements ActionListener
{
	private SkiShop shop;				// SearchItemListener HAS-A Ski Shop

	// Assignment Constructor for search bar and button
	public SearchItemListener(SkiShop shop)
	{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		try
		{
			// Call advancedSearch method to search for skis
			shop.advancedSearch();
		}
