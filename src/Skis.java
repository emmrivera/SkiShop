 ...
 * Skis which have the attributes of a product as well as
 * a size, gender-specificity, skill level, and an option to wax the skis
 */

// Skis IS-A Product and IS Waxable
public class Skis extends Product implements Waxable
{
    private int itemNumber;             // Skis HAS-AN item number (serial number clone for reading from inventory)
    private int size;                   // Skis HAS-A size
    private String gender;              // Skis HAS-A gender-specific type
    private String skillLevel;          // Skis HAS-A skill level its geared for
    private String type = "Skis";       // Skis HAS-A type of gear
    private String sport = "Ski";       // Skis HAS-A sport-specific type
    private String description;         // Skis HAS-A description
    private boolean isWaxed = false;    // Skis HAS-A field to determine if it was waxed

    /**
     * Purpose: constructor that fully initializes the fields of skis
     * including the fields of a product
     * @param brand or make of skis
     * @param model of skis
     * @param price of skis
     * @param size or length of skis
     * @param gender specific skis (Men's or Women's)
     * @param skillLevel or riding ability
     */
    public Skis(String brand, String model, double price,
    ...
    public void addToInventory(Product product) throws IOException
    {
        ...
        {
            // Initialize FileWriter object for writing into a file
            openFile = new FileWriter("SkisInventory.txt", true);
    ...
    public void removeFromInventory(Product product) throws IOException
    {
        ...
        try 
        {
            ...
            newFile = new File("newSkisInventory.txt");
            // Initialize FileWriter object for writing into a new file
            openFile = new FileWriter("newSkisInventory.txt", true);
            // Initialize PrintWriter object for "printing" into file
            outputFile = new PrintWriter(openFile);
            // Initialize File object to access original inventory file
            originalFile = new File("SkisInventory.txt");
    ...
    /**
     * Purpose: display skis product info
