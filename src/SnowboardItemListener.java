 ...
 * To search for snowboards when menu item clicked
 */

public class SnowboardItemListener implements ActionListener
{
	private SkiShop shop;				// SnowboardItemListener HAS-A Ski Shop

	// Assignment Constructor for search bar and button
	public SnowboardItemListener(SkiShop	shop)
	{
